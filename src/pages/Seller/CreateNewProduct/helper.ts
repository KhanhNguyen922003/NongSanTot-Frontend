...
export const productSchema = yup.object({
  ...
  preferredShippingServiceId: yup.string().trim().optional(),
  growthDiary: yup.array().of(
    yup.object({
      stageName: yup.string().trim().required("Nhập tên giai đoạn"),
      logDate: yup.string().trim().required("Nhập thời điểm giai đoạn"),
      description: yup
        .string()
        .trim()
...
export const shippingOptions = [
  { id: "GHTK", label: "GHTK" },
  { id: "SELF_DELIVERY", label: "Người bán tự giao" },
];
